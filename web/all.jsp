                                    ...
                                    <section class="section-products">
                                        ...
                                        <div class="product-list-show" style="display: none">
                                           ...
                                           <div class="product_item col-xs-12">
                                                <form action="detail.jsp?product=<%=p.getProductID()%>" method="post" class="product_item_form">
                                                    <div>
                                        ...
                                        <div class="product-grid-show">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="product_item">
                                                    <form action="detail.jsp?product=<%=p.getProductID()%>" class="product_item_form" method="post">
